...
-- =====================================================================
INSERT INTO repair_record (id, owner_id, house_id, repair_type, repair_content, status, priority, handler_id, handle_content, handle_time, evaluate_score, evaluate_content) VALUES
(1, 1, 1,  '水电', '厨房水龙头漏水，请尽快维修',            3, 2, 12, '更换水龙头密封圈，已修复',            '2026-07-06 15:00:00', 5, '维修师傅很专业，态度好！'),
(2, 3, 6,  '门窗', '卧室窗户关不严，有缝隙进风',          3, 1, 13, '调整窗框铰链，更换密封条',            '2026-07-08 11:00:00', 4, '处理及时'),
(3, 5, 10, '水电', '卫生间马桶堵塞，无法冲水',            3, 3, 12, '疏通马桶，清理管道异物',              '2026-07-04 09:30:00', 5, ''),
(4, 7, 13, '其他', '空调不制冷，制冷效果差',              0, 2, NULL, NULL,                                NULL,                  NULL, NULL),
(5, 2, 3,  '水电', '客厅灯不亮，怀疑线路问题',            0, 1, NULL, NULL,                                NULL,                  NULL, NULL);

-- =====================================================================
-- 18. 投诉建议 (type: 1投诉 2建议 3咨询 4表扬; status: 0待受理 1已受理 2处理中 3已回复 4已关闭; priority: 1普通 2重要 3紧急)
-- =====================================================================
INSERT INTO complaint_suggest (id, owner_id, house_id, type, category, content, status, priority) VALUES
(1, 3, 6,  1, '环境卫生', 'B栋3楼垃圾桶已满两天没人清理，夏天异味严重影响居住。',  3, 3),
(2, 7, 13, 2, '便民服务', '小区快递越来越多，建议在D栋附近增设丰巢快递柜方便取件。', 3, 1),
(3, 1, 1,  4, '服务态度', '保洁李阿姨工作认真负责，楼道总是干干净净，特此表扬！',    3, 1),
(4, 8, 14, 1, '车辆管理', '我的D-002车位被外来车辆占用，请尽快处理。',              0, 2);
