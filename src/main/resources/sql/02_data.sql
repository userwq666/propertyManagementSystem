...
-- 5. 楼栋
-- =====================================================================
INSERT INTO community_building (id, building_name, building_no, floor_count, unit_count, area, completion_date, address, status, remark) VALUES
(1, 'A栋', 'A', 18, 2, 8500.00,  '2018-06-01', '翠湖路1号-A',  1, '高层住宅'),
(2, 'B栋', 'B', 18, 2, 8500.00,  '2018-06-01', '翠湖路1号-B',  1, '高层住宅'),
(3, 'C栋', 'C', 12, 1, 4200.00,  '2019-03-01', '翠湖路1号-C',  1, '小高层'),
(4, 'D栋', 'D', 8,  1, 3800.00,  '2019-03-01', '翠湖路1号-D',  1, '洋房');
...
-- =====================================================================
-- 10. 收费记录 (status: 0未缴 1部分缴纳 2已缴 3逾期 4作废; pay_type: 1现金 2微信 3支付宝 4银行卡 5转账)
-- =====================================================================
...
-- =====================================================================
-- 11. 收费通知 (status: 0草稿 1已发送)
-- =====================================================================
INSERT INTO fee_notice (id, title, content, notice_type, status, send_time, creator_id) VALUES
(1, '2026年7月物业费缴费通知', '尊敬的业主：2026年7月物业费已生成，请在7月15日前完成缴费，逾期将产生滞纳金。', 1, 1, '2026-07-01 09:00:00', 2),
(2, '水费调价通知',           '接市自来水公司通知，自2026年8月起居民用水价格调整为4.05元/吨。',       1, 1, '2026-07-20 10:00:00', 2);

-- =====================================================================
-- 12. 设备分类
-- =====================================================================
INSERT INTO equipment_category (id, category_name, category_code, description, status) VALUES
(1, '电梯系统',   'ELEV',   '乘客电梯、货梯',           1),
(2, '消防系统',   'FIRE',   '消防泵、报警器、灭火器',   1),
(3, '供配电系统', 'POWER',  '变压器、配电柜、发电机',   1),
(4, '给排水系统', 'WATER',  '水泵、水箱、管道',         1),
(5, '安防系统',   'SEC',    '监控、门禁、道闸',         1),
(6, '暖通系统',   'HVAC',   '中央空调、新风系统',       1);

-- =====================================================================
-- 13. 设备信息 (status: 0停用 1正常 2维修中 3报废)
-- =====================================================================
INSERT INTO equipment (id, category_id, equipment_name, equipment_code, brand, model_no, location, install_date, status, remark) VALUES
(1, 1, 'A栋1号电梯',  'EQ-ELEV-A1',  '三菱',    'MAXIEZ-CZ',  'A栋1单元',     '2018-06-01', 1, '载重1000kg'),
(2, 1, 'A栋2号电梯',  'EQ-ELEV-A2',  '三菱',    'MAXIEZ-CZ',  'A栋2单元',     '2018-06-01', 1, '载重1000kg'),
(3, 1, 'B栋1号电梯',  'EQ-ELEV-B1',  '三菱',    'MAXIEZ-CZ',  'B栋1单元',     '2018-06-01', 1, ''),
(4, 2, '消控主机',     'EQ-FIRE-01',  '海湾',    'GST5000',    '消防控制室',   '2018-05-01', 1, ''),
(5, 2, '消防泵组',     'EQ-FIRE-02',  '凯泉',    'KQ系列',     '地下泵房',     '2018-05-01', 1, ''),
(6, 3, '1号变压器',    'EQ-PWR-01',   '特变电工','SCB10-800',  '配电房',       '2018-04-01', 1, '800KVA'),
(7, 3, '备用发电机',   'EQ-PWR-02',   '康明斯',  'QSK23-G3',  '发电机房',     '2018-04-01', 1, '500KW'),
(8, 5, '大门道闸',     'EQ-SEC-01',   '捷顺',    'JS-880',     '小区大门',     '2018-07-01', 1, ''),
(9, 5, '监控主机',     'EQ-SEC-02',   '海康威视','DS-9600',    '监控室',       '2018-07-01', 1, '128路');

-- =====================================================================
-- 14. 设备维保记录 (status: 0计划 1完成 2取消)
-- =====================================================================
INSERT INTO equipment_maintenance (id, equipment_id, maintenance_type, maintenance_date, maintenance_company, maintenance_person, cost, status, content, next_date, remark) VALUES
(1, 1, '半月保', '2026-07-01', '三菱电梯维保公司', '张师傅',  800.00,  1, '电梯半月例行保养：润滑、检查门锁、测试应急通话', '2026-07-15', '正常'),
(2, 2, '半月保', '2026-07-01', '三菱电梯维保公司', '张师傅',  800.00,  1, '电梯半月例行保养',                           '2026-07-15', '正常'),
(3, 3, '半月保', '2026-07-02', '三菱电梯维保公司', '张师傅',  800.00,  1, '电梯半月例行保养',                           '2026-07-16', '正常'),
(4, 4, '季度检', '2026-06-15', '海湾消防维保公司', '李工',   2000.00,  1, '消防主机检测、烟感测试、联动测试',             '2026-09-15', ''),
(5, 6, '年度检', '2026-04-10', '供电局',           '王工',   5000.00,  1, '变压器年度预防性试验',                         '2027-04-10', '合格');

-- =====================================================================
-- 15. 巡检计划 (cycle_type: 1每日 2每周 3每月 4每季; status: 0停用 1启用)
-- =====================================================================
INSERT INTO inspection_plan (id, plan_name, equipment_id, cycle_type, inspection_items, status, creator_id) VALUES
(1, '电梯日常巡检',   1, 1, '运行声音、平层精度、门开关、应急电话、照明',             1, 3),
(2, '消防设施巡检',   4, 2, '主机运行状态、烟感指示灯、灭火器压力、疏散指示',          1, 3),
(3, '配电房巡检',     6, 1, '变压器温度、电压电流、有无异响异味、环境温湿度',          1, 3),
(4, '安防设备巡检',   8, 2, '摄像头画面、录像存储、门禁读卡器、道闸升降',              1, 3),
(5, '给排水系统巡检', NULL, 3, '水泵运行状态、水箱水位、管道有无渗漏、阀门状态',       1, 3);
...
-- =====================================================================
-- 17. 报修记录 (status: 0待处理 1处理中 2已完成 3已取消; emergency_level: 1普通 2紧急 3特急)
-- =====================================================================
INSERT INTO repair_record (id, repair_no, owner_id, house_id, repair_type, description, emergency_level, status, repair_person_id, repair_content, complete_time, score, score_comment) VALUES
(1, 'RR202607001', 1, 1,  '水电', '厨房水龙头漏水，请尽快维修',            2, 2, 12, '更换水龙头密封圈，已修复',            '2026-07-06 15:00:00', 5, '维修师傅很专业，态度好！'),
(2, 'RR202607002', 3, 6,  '门窗', '卧室窗户关不严，有缝隙进风',          1, 2, 13, '调整窗框铰链，更换密封条',            '2026-07-08 11:00:00', 4, '处理及时'),
(3, 'RR202607003', 5, 10, '水电', '卫生间马桶堵塞，无法冲水',            3, 2, 12, '疏通马桶，清理管道异物',              '2026-07-04 09:30:00', 5, ''),
(4, 'RR202607004', 7, 13, '其他', '空调不制冷，制冷效果差',              2, 1, NULL, NULL,                                NULL,                  NULL, NULL),
(5, 'RR202607005', 2, 3,  '水电', '客厅灯不亮，怀疑线路问题',            1, 0, NULL, NULL,                                NULL,                  NULL, NULL);

-- =====================================================================
-- 18. 投诉建议 (type: 1投诉 2建议 3表扬; status: 0待处理 1处理中 2已完成; is_public: 0仅本人 1公开)
-- =====================================================================
INSERT INTO complaint_suggest (id, complaint_no, owner_id, house_id, type, category, title, content, is_public, status, result, handle_time, handler_id) VALUES
(1, 'CP202607001', 3, 6,  1, '环境卫生', '楼道垃圾未及时清理',  'B栋3楼垃圾桶已满两天没人清理，夏天异味严重影响居住。',  1, 2, '已安排保洁立即清理，并增加巡查频次',                       '2026-07-08 15:00:00', 2),
(2, 'CP202607002', 7, 13, 2, '便民服务', '建议增设丰巢快递柜',  '小区快递越来越多，建议在D栋附近增设丰巢快递柜方便取件。', 1, 2, '已向物业经理反馈，正在与丰巢洽谈合作。',                   '2026-07-10 14:00:00', 2),
(3, 'CP202607003', 1, 1,  3, '服务态度', '表扬保洁李阿姨',      '保洁李阿姨工作认真负责，楼道总是干干净净，特此表扬！',    1, 2, '感谢您的肯定，已转达给保洁团队。',                         '2026-07-05 16:00:00', 2),
(4, 'CP202607004', 8, 14, 1, '车辆管理', '外来车辆占用车位',    '我的D-002车位被外来车辆占用，请尽快处理。',              0, 0, NULL,                                                      NULL,                  NULL);
