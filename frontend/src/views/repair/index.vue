<template>
  <div>
    ...
    <div class="table-container">
      <div class="toolbar">
        <div class="toolbar-left"><el-button type="primary" @click="handleAdd">新增报修</el-button></div>
      ...
      <el-table :data="tableData" border stripe v-loading="loading">
        ...
        <el-table-column label="操作" width="240" fixed="right">
          <template #default="{ row }">
            ...
            <el-button v-if="row.status===0" type="warning" size="small" @click="handleStatus(row)">处理</el-button>
            <el-button v-if="row.status===2 && !row.score" type="success" size="small" @click="handleRating(row)">评价</el-button>
          </template>
        </el-table-column>
      </el-table>
